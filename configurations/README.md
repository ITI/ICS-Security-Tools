...
* [Quickdraw Suricata Signatures](https://github.com/digitalbond/Quickdraw-Suricata) - A set of ICS IDS rules for use with Suricata. See the [pcap quickdraw](../pcaps/quickdraw/) section for some potential test pcaps.
